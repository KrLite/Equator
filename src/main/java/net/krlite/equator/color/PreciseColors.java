...
public class PreciseColors {
	...
	// Foreground
	public static final PreciseColor MINECOIN_GOLD = PreciseColor.from(0xDDD605);
	public static final PreciseColor MINECRAFT_BLACK = PreciseColor.from(0x000000);
	public static final PreciseColor MINECRAFT_DARK_BLUE = PreciseColor.from(0x0000AA);
	public static final PreciseColor MINECRAFT_DARK_GREEN = PreciseColor.from(0x00AA00);
	public static final PreciseColor MINECRAFT_DARK_AQUA = PreciseColor.from(0x00AAAA);
	public static final PreciseColor MINECRAFT_DARK_RED = PreciseColor.from(0xAA0000);
	public static final PreciseColor MINECRAFT_DARK_PURPLE = PreciseColor.from(0xAA00AA);
	public static final PreciseColor MINECRAFT_GOLD = PreciseColor.from(0xFFAA00);
	public static final PreciseColor MINECRAFT_GRAY = PreciseColor.from(0xAAAAAA);
	public static final PreciseColor MINECRAFT_DARK_GRAY = PreciseColor.from(0x555555);
	public static final PreciseColor MINECRAFT_BLUE = PreciseColor.from(0x5555FF);
	public static final PreciseColor MINECRAFT_GREEN = PreciseColor.from(0x55FF55);
	public static final PreciseColor MINECRAFT_AQUA = PreciseColor.from(0x55FFFF);
	public static final PreciseColor MINECRAFT_RED = PreciseColor.from(0xFF5555);
	public static final PreciseColor MINECRAFT_LIGHT_PURPLE = PreciseColor.from(0xFF55FF);
	public static final PreciseColor MINECRAFT_YELLOW = PreciseColor.from(0xFFFF55);
	public static final PreciseColor MINECRAFT_WHITE = PreciseColor.from(0xFFFFFF);
	// Background
	public static final PreciseColor MINECOIN_BACKGROUND_GOLD = PreciseColor.from(0x373501);
	public static final PreciseColor MINECRAFT_BACKGROUND_BLACK = PreciseColor.from(0x000000);
	public static final PreciseColor MINECRAFT_BACKGROUND_DARK_BLUE = PreciseColor.from(0x00002A);
	public static final PreciseColor MINECRAFT_BACKGROUND_DARK_GREEN = PreciseColor.from(0x002A00);
	public static final PreciseColor MINECRAFT_BACKGROUND_DARK_AQUA = PreciseColor.from(0x002A2A);
	public static final PreciseColor MINECRAFT_BACKGROUND_DARK_RED = PreciseColor.from(0x2A0000);
	public static final PreciseColor MINECRAFT_BACKGROUND_DARK_PURPLE = PreciseColor.from(0x2A002A);
	public static final PreciseColor MINECRAFT_BACKGROUND_GOLD = PreciseColor.from(0x2A2A00);
	public static final PreciseColor MINECRAFT_BACKGROUND_GOLD_BEDROCK = PreciseColor.from(0x402A00);
	public static final PreciseColor MINECRAFT_BACKGROUND_GRAY = PreciseColor.from(0x2A2A2A);
	public static final PreciseColor MINECRAFT_BACKGROUND_DARK_GRAY = PreciseColor.from(0x151515);
	public static final PreciseColor MINECRAFT_BACKGROUND_BLUE = PreciseColor.from(0x15153F);
	public static final PreciseColor MINECRAFT_BACKGROUND_GREEN = PreciseColor.from(0x153F15);
	public static final PreciseColor MINECRAFT_BACKGROUND_AQUA = PreciseColor.from(0x153F3F);
	public static final PreciseColor MINECRAFT_BACKGROUND_RED = PreciseColor.from(0x3F1515);
	public static final PreciseColor MINECRAFT_BACKGROUND_LIGHT_PURPLE = PreciseColor.from(0x3F153F);
	public static final PreciseColor MINECRAFT_BACKGROUND_YELLOW = PreciseColor.from(0x3F3F15);
	public static final PreciseColor MINECRAFT_BACKGROUND_WHITE = PreciseColor.from(0x3F3F3F);
	// Miscellaneous
	public static final PreciseColor MINECRAFT_MISSING_TEXTURE_PURPLE = PreciseColor.from(0xF800F8);
	public static final PreciseColor MINECRAFT_MISSING_TEXTURE_BLACK = PreciseColor.from(0x000000);
